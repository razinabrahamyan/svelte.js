<script lang="ts">
	...
	<div class="container text-black">
		...
		{/if}
		{#if !cropping}
			<button on:click={openCrop} class="btn btn-primary text-white p-0.5"  title="size"> <Icon icon="material-symbols:crop" width="24" /> </button>
			{:else}
			<button on:click={cropImage} class="btn btn-primary text-white p-0.5" title="save"> <Icon icon="material-symbols:save" width="24" /> </button>
			{/if}

		<button on:click={blurCrop} class="btn btn-primary text-white p-0.5" title="blur"><Icon icon="ic:round-blur-circular" width="24"/></button>

		<button on:click={newCenter} class="btn btn-primary text-white p-0.5" title="center"> <Icon icon="material-symbols:center-focus-strong"  width="24"/></button>
		<label for="small-range" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white flex justify-center w-full"><Icon icon="material-symbols:rotate-left-rounded"  width="24" /></label>
